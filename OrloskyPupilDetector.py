...
if __name__ == "__main__":
    ...
    if "--camera" in sys.argv:
        # Live webcam mode: camera index can be passed as --camera 0 (default 0)
        cam_index = 0
        try:
            ...
            pass
        print(f"Starting live camera tracking on camera index {cam_index}...")
        process_video(cam_index, 2)
    else:
        select_video()
